...
public class PCBookSeatActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDatePicker = (Button) findViewById(R.id.btn_datep);
        btnTimePicker = (Button) findViewById(R.id.btn_timep);
        txtDate = (EditText) findViewById(R.id.in_datep);
        txtTime = (EditText) findViewById(R.id.in_timep);
        btnDatePickerTo = (Button) findViewById(R.id.btn_datetop);
        btnTimePickerTo = (Button) findViewById(R.id.btn_timetop);
        txtDateTo = (EditText) findViewById(R.id.in_datetop);
        txtTimeTo = (EditText) findViewById(R.id.in_timetop);
        ...
        buttonConfirmTime = (Button) findViewById(R.id.button_confirm_timep);
...
//                builder.setView(inflater.inflate(R.layout.dialogue_confirm_booking, null));
                ...
                builder.setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface arg0, int arg1) {
                        PCBookSeatActivity.this.bookSeat(seatId);
    ...
    public void onGetMyBookingsSuccess(List<TimeSlot> list) {
        ...
        if (free == false) {
            ...
            builder.setNeutralButton("ReEnter", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface arg0, int arg1) {
                            buttonConfirmTime.setEnabled(false);
                            PCBookSeatActivity.this.recreate();
                        }
                    }
            );
            builder.show();
