...
public class TempInCaptureActivity extends AppCompatActivity implements ZXingScannerView.ResultHandler {
...
//        Log.d("debug", SignInUseCases.user.getId().toString());
        ...
        TimeSlot t = scanOptionUseCases.getTmpBackTimeSlot((NormalUser) SignInUseCases.user);
